...
exports.default = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, books_service_1.default.getBooks()];
                case 1:
                    booksList = _a.sent();
    ...
    getBookDetails: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var bookDetails, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, books_service_1.default.getBookDetails(req.params.book_id)];
                case 1:
                    bookDetails = _a.sent();
    ...
    deleteBook: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var deletedBook, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, books_service_1.default.deleteBook(req.params.book_id)];
                case 1:
                    deletedBook = _a.sent();
                    if (!deletedBook) {
                        throw new Error();
    ...
    getBookReviews: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var reviewsList, e_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, books_service_1.default.getBookReviews(req.params.book_id)];
                case 1:
                    reviewsList = _a.sent();
                    if (!reviewsList) {
                        throw new Error();
                ...
                case 2:
                    e_6 = _a.sent();
                    e_6.message = "Either BookId or Review Id is not found";
    ...
    createBookReview: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    e_7 = _a.sent();
                    e_7.message = "Either BookId or Review Id is not found";
    ...
    getBookReview: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var bookReview, e_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, books_service_1.default.getBookReview(req.params.review_id)];
                case 1:
                    bookReview = _a.sent();
                    if (!bookReview) {
                        throw new Error();
                    ...
                    return [2 /*return*/, res.json({ statusCode: 200, message: "Ok" }).status(200)];
                case 2:
                    e_9 = _a.sent();
    ...
    deleteBookReview: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, books_service_1.default.deleteBookReview(req.params.book_id, req.params.review_id)];
                case 2:
