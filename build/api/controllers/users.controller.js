...
var okta_client_service_1 = __importDefault(require("../../services/okta-client.service"));
var logger_1 = __importDefault(require("../../loaders/logger"));
exports.default = {
    registerOktaUser: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, okta_client_service_1.default.register(req.body)];
                case 1:
                    _a.sent();
    ...
    loginOktaUser: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var sessionData, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, okta_client_service_1.default.sessionLogin(req.body)];
                case 1:
                    sessionData = _a.sent();
